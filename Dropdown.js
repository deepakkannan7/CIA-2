    ...
    return (
       ...
       <center> <div className="dropdown">
            <div className="dropdown-btn" onClick={() => setIsOpen(!isOpen)}>
               <center> <p id="label">Choose one</p></center>
                {isOpen ? (
            ...
            {isOpen && (
              <div className="dropdown-content">
                    {colors.options.map(color => (
                        ...
                        <center><div className="dropdown-item" onClick={() => { document.body.style.backgroundColor = color.value ; document.getElementById("label").innerHTML = color.label ; }}>
                            {color.label}
